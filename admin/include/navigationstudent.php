                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                              ...
                              <li>
                                ...
                                <ul class="nav nav-third-level">
                                  <li>
                                    <a href="leerplandoellist.php">Leerplan doelstelling lijst</a>
                                  </li>
                                  <li>
                                    <a href="leerplandoeladd.php">Leerplan doelstelling aanmaken</a>
                                  </li>
                                </ul>
                              </li>
                              <li>
                                ...
                                <ul class="nav nav-third-level">
                                  <li>
                                    <a href="niveaulist.php">Niveau lijst</a>
                                  </li>
                                  <li>
                                    <a href="niveauadd.php">Niveau aanmaken</a>
                                  </li>
                                </ul>
                              </li>
                              <li>
