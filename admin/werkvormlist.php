...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h2 class="page-header">Werkvorm lijst</h2>
    </div>
        <!-- /.col-lg-12 -->
  </div>
...
<?php
//create the query
$result = mysql_query("select werkvormid, werkvorm from werkvormen");
...
?>
    <tr class="odd">
      ...
      <td align="right"> 
        <a href="werkvormmodify.php?id=<?php echo $row['werkvormid'];?>"><i class="fa fa-edit fa-fw"></i></a>
      </td>
    </tr>
