...
<body>
    ...
    <?php if($uploadedStatus==1){
        header("location:studentklasupload.php");
...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h2 class="page-header">Cursisten aan een klas toevoegen</h2>
    </div>
        <!-- /.col-lg-12 -->
  </div>
        ...
        <div class="dataTable_wrapper">
          <table>
            ...
            <tr>
              ...
              <td align="right"><button type="submit" name="submit" class="btn btn-primary">Opladen</button></td>
